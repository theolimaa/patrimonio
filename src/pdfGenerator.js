...
<div class="section">
  ...
  ${(sucessao.patrimonioFinanceiro || 0) > 0 ? `<div class="nb"><table><thead><tr><th>Patrimônio Financeiro</th><th class="right">Valor</th><th class="right">Inventariável</th></tr></thead><tbody><tr><td>Investimentos, poupança e aplicações</td><td class="right mono">${fmtBRL(sucessao.patrimonioFinanceiro || 0)}</td><td class="right mono">${fmtBRL((sucessao.patrimonioFinanceiro || 0) * (sucessao.regimeCasamento === 'separacao_total' ? 1 : 0.5))}</td></tr>${(sucessao.previdenciaNum || 0) > 0 ? '<tr><td>Previdência privada (PGBL/VGBL) — não inventariável</td><td class="right mono">' + fmtBRL(sucessao.previdenciaNum) + '</td><td class="right mono" style="color:#15803d">Isento</td></tr>' : ''}</tbody></table></div>` : ''}
