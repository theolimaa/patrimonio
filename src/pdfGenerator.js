...
<div class="section">
  ...
  ${(sucessao.patrimonioFinanceiro || 0) > 0 ? `<div class="nb"><table><thead><tr><th>Patrimônio Financeiro</th><th class="right">Valor</th></tr></thead><tbody><tr><td>Investimentos, poupança e aplicações</td><td class="right mono">${fmtBRL(sucessao.patrimonioFinanceiro || 0)}</td></tr></tbody></table></div>` : ''}
